...
func TestCountQuery(t *testing.T) {
	...
	// CountQuery.Where
	q1.Where2(GreaterEqual2[Person](this, &p.Age, 18))
	// CountQuery.Test
...
func TestValueQuery(t *testing.T) {
	...
	// ValueQuery.Where
	q1.Where2(Equal2[User](this, &u.Code, "admin"))
...
func TestSelectRowQuery(t *testing.T) {
	...
	q1.Where2(Equal2[Company](this, &c.Name, "Google"))
	q2.Where2(Equal2[Company](this, &c.Code, "XYZ"))
	q3.Where2(Greater2[Company](this, &c.Age, 10))
	q4.Where2(NotIn2[Company](this, &c.Type, []string{"IT", "Finance"}))
	// SelectRowQuery.Test
...
func TestTopRowQuery(t *testing.T) {
	...
	// TopRowQuery.Where
	q1.Where2(Greater2[User](this, &u.Balance, 0))
	q2.Where2(GreaterEqual2[User](this, &u.Age, 10))
	q5.Where2(Greater2[User](this, &u.Age, 0))
	// TopRowQuery.Columns
	q2.Columns(this, cols2...)
...
func TestTopValueQuery(t *testing.T) {
	...
	// TopValueQuery.Where
	q1.Where2(Greater2[User](this, &u.Balance, 0))
	q2.Where2(Greater2[User](this, &u.Age, 10))
	q5.Where2(Greater2[User](this, &u.Age, 0))
	q6.Where2(Greater2[User](this, &u.Age, 10))
...
func TestSumQuery(t *testing.T) {
	...
	// SumQuery.Where
	q1.Where2(Greater2[Product](this, &p.ID, 100))
	q2.Where2(Lesser2[Product](this, &p.Price, 50.0))
