...
func TestDistinctValuesQuery(t *testing.T) {
	...
	q1.Where2(Equal2[User](this, &u.Age, 18))
	...
	q7.Where2(Lesser2[User](this, &u.Age, 10))
...
func TestLookupQuery(t *testing.T) {
	...
	q0.Where2(Lesser2[User](this, &u.Age, 10))
	q1 := NewLookupQuery[User](this, table, &u.Username, &u.Age)
	q1.Where2(Greater2[User](this, &u.Age, 18))
...
func TestSelectRowsQuery(t *testing.T) {
	...
	q1.Where2(Greater2[Product](this, &p.Price, 100.0))
	q2.Where2(Equal2[Product](this, &p.Stock, 50))
	q8.Where2(Equal2[Product](this, &p.Name, "Computer"))
...
func TestGroupCountQuery(t *testing.T) {
	...
	q3.Where2(Greater2[User](this, &u.Age, 18))
	q7.Where2(Greater2[User](this, &u.ID, 10))
...
func TestGroupSumQuery(t *testing.T) {
	...
	// GroupSumQuery.Where
	q3.Where2(Greater2[Product](this, &p.Qty, 10))
	q10.Where2(Greater2[Product](this, &p.ID, 10))
